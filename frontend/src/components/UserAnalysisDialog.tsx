...
export const RISK_FLAG_LABELS: Record<string, string> = {
    'HIGH_RPM': '请求频率过高',
    'MANY_IPS': '多IP访问',
    'MANY_IPS_SEVERE': '多IP严重异常',
    'MANY_IPS_EXTREME': '多IP极高风险',
    'HIGH_FAILURE_RATE': '失败率过高',
    'HIGH_EMPTY_RATE': '空回复率过高',
    'EMPTY_RESPONSE_ABUSE': '空回复滥用',
    'IP_RAPID_SWITCH': 'IP快速切换',
    'IP_HOPPING': 'IP跳动异常',
    'TOKEN_ROTATION': '令牌轮换异常',
    'BLACKLIST_IP': '命中黑名单IP',
...
export const BAN_REASONS = [
    ...
    { value: '多 IP 严重异常 (MANY_IPS_SEVERE)', label: '多 IP 严重异常 (MANY_IPS_SEVERE)' },
    { value: '多 IP 极高风险 (MANY_IPS_EXTREME)', label: '多 IP 极高风险 (MANY_IPS_EXTREME)' },
    { value: '失败率过高 (HIGH_FAILURE_RATE)', label: '失败率过高 (HIGH_FAILURE_RATE)' },
    { value: '空回复率过高 (HIGH_EMPTY_RATE)', label: '空回复率过高 (HIGH_EMPTY_RATE)' },
    { value: '空回复滥用 (EMPTY_RESPONSE_ABUSE)', label: '空回复滥用 (EMPTY_RESPONSE_ABUSE)' },
    { value: 'IP快速切换 (IP_RAPID_SWITCH)', label: 'IP快速切换 (IP_RAPID_SWITCH)' },
    { value: 'IP跳动异常 (IP_HOPPING)', label: 'IP跳动异常 (IP_HOPPING)' },
    { value: '令牌轮换异常 (TOKEN_ROTATION)', label: '令牌轮换异常 (TOKEN_ROTATION)' },
    { value: '命中黑名单IP (BLACKLIST_IP)', label: '命中黑名单IP (BLACKLIST_IP)' },
